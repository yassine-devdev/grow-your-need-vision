                ...
                <div className="p-4 md:p-8 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div className="grid grid-cols-3 gap-2 md:gap-6">
                        ...
                        <button 
                            ...
                            className={`relative p-2 md:p-4 rounded-xl border-2 transition-all duration-200 flex flex-col items-center gap-2 md:gap-3 group ${
                                theme === 'light' 
                        ...
                        >
                            <div className={`w-8 h-8 md:w-12 md:h-12 rounded-full flex items-center justify-center transition-colors ${
                                theme === 'light' ? 'bg-gyn-blue-medium text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 group-hover:text-gyn-blue-medium'
                            }`}>
                        ...
                        >
                            <div className={`w-8 h-8 md:w-12 md:h-12 rounded-full flex items-center justify-center transition-colors ${
                                theme === 'dark' ? 'bg-gyn-blue-medium text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 group-hover:text-gyn-blue-medium'
                            }`}>
                        ...
                        >
                            <div className={`w-8 h-8 md:w-12 md:h-12 rounded-full flex items-center justify-center transition-colors ${
                                theme === 'system' ? 'bg-gyn-blue-medium text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 group-hover:text-gyn-blue-medium'
                            }`}>
