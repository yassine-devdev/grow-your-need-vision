...
const EmptyState: React.FC<EmptyStateProps> = ({ 
  ...
  return (
    <div className={`flex flex-col items-center justify-center p-8 text-center w-full h-full min-h-[200px] animate-fadeIn ${className}`}>
